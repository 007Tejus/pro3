	...
	int main()
	{
		...
		do{
			...
			switch(choice)
			{
				case 1:	 printf("\nEnter the ISBN, title, author and price of the book to push:\n");
					scanf("%d %s %s %f, ",&b1.ISBN, b1.title, b1.author, &b1.price);
					push(&s,b1);
					break;
				case 2: r1=pop(&s);
					printf("\nThe details of BOOK popped is :\n");
					printf("\n ISBN =%d,  Title=%s, Author=%s, Price=%f", r1.ISBN, r1.title, r1.author, r1.price);					break;
				case 3: display(&s);
					break;
					printf("\n Stack empty");
